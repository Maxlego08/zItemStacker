...
public abstract class VCommand extends Arguments {
	...
	public CommandType prePerform(ZItemPlugin main, CommandSender commandSender, String[] args) {
	 ...
	 */
	protected abstract CommandType perform(ZItemPlugin main);
	 ...
	 * @return
	 */
	public List<String> toTab(ZItemPlugin plugin, CommandSender sender2, String[] args) {
		return null;
	}
