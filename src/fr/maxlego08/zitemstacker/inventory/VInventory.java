package fr.maxlego08.zitemstacker.inventory;
...
import fr.maxlego08.zitemstacker.exceptions.InventoryOpenException;
import fr.maxlego08.zitemstacker.zcore.utils.ZUtils;
import fr.maxlego08.zitemstacker.zcore.utils.builder.ItemBuilder;
import fr.maxlego08.zitemstacker.zcore.utils.inventory.InventoryResult;
import fr.maxlego08.zitemstacker.zcore.utils.inventory.ItemButton;

public abstract class VInventory extends ZUtils implements Cloneable {

	protected int id;
	protected ZItemPlugin plugin;
	...
	protected InventoryResult preOpenInventory(ZItemPlugin main, Player player, int page, Object... args)
	...
	public abstract InventoryResult openInventory(ZItemPlugin main, Player player, int page, Object... args)
			throws InventoryOpenException;
	 ...
	 * @param player
	 */
	protected void onClose(InventoryCloseEvent event, ZItemPlugin plugin, Player player) {
	}
	 ...
	 * @param player
	 */
	protected void onDrag(InventoryDragEvent event, ZItemPlugin plugin, Player player) {
	}
